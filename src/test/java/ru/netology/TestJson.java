...
public class TestJson {
        ...
        void shouldSuccessfulLoginIfRegisteredActiveUser() {
            ...
            $("[data-test-id='login'] .input__control").setValue(getRegisteredUser("active").getLogin());
            $("[data-test-id='password'] .input__control").setValue(getRegisteredUser("active").getPassword());
